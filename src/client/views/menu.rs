use iced::{
    ContentFit, Element, widget::{
        Column, Image, column, container, pick_list, row, scrollable, slider, stack, text, text_input
    }
};
...
pub fn view_main_menu<'a>(state: &'a App) -> Element<'a, AppMessage> {
    ...
    stack![
        Image::new("assets/menu/wizard_main_menu.png")
...
pub fn view_host_menu<'a>(state: &'a App) -> Element<'a, AppMessage> {
    ...
    stack![
        background_image("assets/menu/background_forall.png"),
        menu_panel(
            state,
            "Spiel hosten:",
            content.into(),
